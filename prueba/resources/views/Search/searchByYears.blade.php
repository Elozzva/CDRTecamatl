        ...
        <div class="inner-form">
            ...
            <div class="input-field fouth-wrap">
              ...
              <div class="input-field fouth-wrap">
                ...
                <select id="Car" onchange="searchModel()" data-trigger="" name="choices-single-defaul">
                    @forelse ($Carros as $Carro)
                    @if ($Carro['id'] == $id)
                         <option selected value="{{ $Carro['name'] }}">{{ $Carro['name'] }}</option>
                    @else
                         <option value="{{ $Carro['name'] }}">{{ $Carro['name'] }}</option>
                    @endif
          ...
          <div class="input-field fouth-wrap">
            ...
            <select id="CarYear" onchange="searchProduct()" data-trigger="" name="choices-single-defaul">
                @forelse ($Carros as $Carro)
                @if ($Carro['id'] == $id)
                     <option selected value="{{ $Carro['id'] }}">{{ $Carro['model'] }}</option>
                @else
                     <option value="{{ $Carro['id'] }}">{{ $Carro['model'] }}</option>
                @endif
    ...
    <script>
      ...
      function goSearch() {
        ...
        function searchModel() {
            ...
            //alert(x);
            window.open("/searchByYears/" + x, "_self");
        }
